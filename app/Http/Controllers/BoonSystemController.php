...
class BoonSystemController extends Controller {
	...
	public function index()
	{
		...
		$list = BoonSystem::where('user_id', Auth::user()->id)->orderBy('id', 'desc')->paginate(9);
		//$ccMails = DB::table('ccmails_order')->orderBy('id', 'desc')->paginate(9);

		return view('boon.boonSystem.list', compact('list'));
	}
	...
	public function show($id, $direction = null)
	{
		...
		$userReq = BoonSystem::findOrFail($id);
