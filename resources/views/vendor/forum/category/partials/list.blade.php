<tr>
    <td {{ $category->threadsEnabled ? '' : 'colspan=5'}}>
        ...
        <small style="color:darkgrey;">{{--1글 / 5내용--}}
    ...
    @if ($category->threadsEnabled)
        <td>
            ...
            @if ($category->newestThread)
                <a href="{{ Forum::route('thread.show', $category->newestThread) }}" style="color:darkgrey;">
            ...
            @if ($category->latestActiveThread)
                <a href="{{ Forum::route('thread.show', $category->latestActiveThread->lastPost) }}" style="color:darkgrey;">
