...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<meta name="keywords" content="인터파크소송, 코웨이, 코웨이소송, 중금속집단소송, 민형사 집단소송, 지식재산권 분쟁, 내용증명, 원스탑 소송지원" />
								...
								@else
									...
									{{--세션에 메세지 있으면 보여주기--}}
										...
										<div class="text-center">
											<a href="/wave/mypage?suit_id=<?=$request->suit_number?>" class="btn btn-lg btn-warning" style="color:black"> ▶ 접수 / 관리</a>
										</div>
									</div>
				...
				<div class="row p-b">
					<div class="col-md-6 col-md-offset-3">
						...
						<p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
							코웨이/청호 정수기 중금속 니켈 검출에 대한 소비자 소송
						</p>
...
<h3>1. 신청자격의 안내</h3>
						...
						<ul>
							...
							<li>라. 기타 문제된다고 보고된 정수기 사용자 (청호나이스 포함)</li>
						</ul>

						<p>※ 청호나이스 제품군 및 최초 문제삼지 않은 코웨이 정수기의 경우에도 우선 접수를 받습니다. 다만 실제 소송진행이 불가할 경우 전액 환불드립니다.</p>
<h3>2. 손해배상 소송에 대하여</h3>

						<p>가. 안녕하십니까. 법무법인 예율입니다. 코웨이 및 청호나이스는 현재 자사 정수기의 니켈 성분 검출에 대하여 사죄의 뜻을 표하며, 사용기간 중 렌탈료의 환불 및 제품 무상 교환조치를 제시하였습니다.</p>
...
<p><b>(2) B타입 – 위자료, 검진비에 치료비를 추가적으로 청구하는 경우</b></p>
	<div style="padding-left:20px;">
						...
						<p>(라) 현재 제조물 책임에 대한 다수의 판례는 소비자의 상해와 제조물의 결함 사이에 인과관계를 쉽게 인정하지 않고 있으나, 법무법인 예율은 본 코웨이/청호 소비자 단체소송을 통하여 이에 대한 선례를 남기고자 하오니, B타입에 적극적인 참여를 부탁드립니다.</p>
...
<h3>4. 유의사항</h3>
						...
						<p>1) 코웨이/청호 측과 개별적으로 제품교환 및 렌탈료의 반환을 받아, 합의를 경료한(<u>추후 민형사상의 이의를 제기하지 아니하기로 하는 취지의 합의</u>) 소비자의 경우 소송의 참여가 불가함을 고지드립니다.</p>

						<p>2) 현재 이후부터 코웨이/청호가 제시하는 서류에 임의로 서명 및 날인하지 마시고, 제품 “교환”이 아닌 새로운 제품 “지급”을 요청하시기 바랍니다(추후 정수기 음용수에 대한 중금속 농도 수질감정이 필요합니다. 모든 원고의 제품을 검사하지는 않으나 저희가 요청하는 경우 도움을 주셔야 할 수도 있습니다).</p>
					...
					<div class="col-md-6 col-md-offset-3 text-center">
						...
						<div id="div비용표" style="display:block;">
							<table class="table text-center">
								...
								<tr>
									<td></td>
									<td colspan="6"><b style="font-size:1.2em;">신한 100-029-697933 법무법인 예율</b>
										<div>
